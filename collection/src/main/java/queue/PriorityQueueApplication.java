...
public class PriorityQueueApplication
{
    ...
    public static void main(String[] args) {
       ...
       //Comparing guest and get loyality members and put them ahead of other guest
       Comparator<Guest> programCompare = 
                        Comparator.comparing(Guest::isLoyaltyProgramMember).reversed();
       Queue<Guest> checkInQueue = new PriorityQueue<>(programCompare);
